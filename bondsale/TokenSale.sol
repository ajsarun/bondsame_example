...
//Based-on Crowdsale from Openzepplin (3.x)
contract TokenSale {
     ...
     */
    constructor (uint _rate, address payable _wallet, ERC20Interface _token) {
     ...
     */
    function getToken() public view returns (ERC20Interface) {
        return token;
    }
     /**
